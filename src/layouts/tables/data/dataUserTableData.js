...
<MDButton variant="text" color="dark" onClick={() => handleEditClick(user._id)}>
  ...
  return {
    columns: [
      ...
      { Header: "Nome da Doença/Praga", accessor: "function", align: "left" },
      { Header: "Valor Calculado", accessor: "create", align: "center" },
      { Header: "Data da Ação", accessor: "action", align: "center" },
    ],
